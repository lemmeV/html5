...
foreach($sentences as $sentence) {
    ...
    echo is_first_word_a_name($sentence_array[0],$new_text);
    echo "<br>";
    //var_dump($sentence_array);

        //preg_match_all('/\b[A-Z][a-zA-Z]*\b/', $sentence, $matches);
        //var_dump($matches);

//    foreach ($sentence_array as $word) {
//        echo $word . "<br>";
//        is_first_word_a_name($word,$fullText);
//        echo "<br>";
//    }
//    echo "<br>";
...
//var_dump($array);
//$test = preg_match("/^[A-Z]/", $fullText);

/**
 * @param $word
 * @param $fullText
 * @return bool
 * Function to test whether the original text contains the first word of the sencence in lowercase
 */

function conform_sentence_punctuation($fullText) {
...
function is_first_word_a_name($word,$fullText) {
...
function remove_first_words_of_sentence($fullText) {

    $sentences = explode('.',$fullText);
